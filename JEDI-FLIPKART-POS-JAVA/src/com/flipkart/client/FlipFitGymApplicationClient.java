...
public class FlipFitGymApplicationClient {

    public static int userId = 0;
    public static Scanner scanner = new Scanner(System.in);
    private static FlipFitGymAdminClient adminClient = new FlipFitGymAdminClient();
    private static FlipFitCustomerClient customerClient = new FlipFitCustomerClient();
    private static FlipFitGymOwnerClient gymOwnerClient = new FlipFitGymOwnerClient();
