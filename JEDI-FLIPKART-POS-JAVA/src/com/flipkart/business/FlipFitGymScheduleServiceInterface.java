 ...
 */
public interface FlipFitGymScheduleServiceInterface {
     ...
     */
    FlipfitGymSchedule createSchedule(Date date, String slotId);
     ...
     */
    FlipfitGymSchedule getScheduleByDateAndSlotId(String slotId, Date date);
     ...
     */
    List<FlipfitGymSchedule> checkAvailability(String centreID, Date date);
     ...
     * @return Schedule object representing the details of the schedule
     */
    FlipfitGymSchedule getOrCreateSchedule(String slotId, Date date);
}
