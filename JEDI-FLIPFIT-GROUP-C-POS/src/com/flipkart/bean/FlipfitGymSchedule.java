 ...
 */
public class FlipfitGymSchedule {
     ...
     */
    public FlipfitGymSchedule(Date date, String slotID, int availability) {
     ...
     * @param availability The availability status of the schedule.
     */
    public FlipfitGymSchedule(String scheduleID, Date date, String slotID, int availability) {
