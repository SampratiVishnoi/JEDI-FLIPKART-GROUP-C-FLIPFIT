...
public class FlipfitGymCentre {
     ...
     */
    public FlipfitGymCentre(String gymCentreID, String ownerID, String gymCenterName, String gstin, String city, int capacity, int price, int isApproved) {
     ...
     */
    public FlipfitGymCentre(String gymCentreID, String ownerID, String gymCenterName, String city, int approved) {
        this.gymCentreID = gymCentreID;
        this.ownerID = ownerID;
        this.gymCenterName = gymCenterName;
        this.city = city;
     ...
     * @param price       The price associated with the gym center.
     */
    public FlipfitGymCentre(String gymCentreID, String ownerID, String gymCenterName, String gstin, String city, int capacity, int price) {
        this.gymCentreID = gymCentreID;
        this.ownerID = ownerID;
        this.gymCenterName = gymCenterName;
        this.gstin = gstin;
