...
import com.flipkart.business.FlipFitGymAdminServiceInterface;
...
public class FlipFitGymAdminClient {
    ...
    private static FlipfitGymAdmin admin = new FlipfitGymAdmin();
    private static FlipFitGymAdminServiceInterface adminService = new FlipfitGymAdminService();
    private static FlipfitGymOwnerServiceInterface gymOwnerService = new FlipFitGymOwnerService();
    ...
    public void adminClientMainPage(){
        ...
        while(true){
            ...
            switch (pendingChoice) {
                ...
                case 2:
                    List<FlipfitGymCentre> pendingGymCentres = adminService.viewPendingGymCentres();//get listGymCenterIds
