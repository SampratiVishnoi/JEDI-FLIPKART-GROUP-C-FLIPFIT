...
public interface FlipFitGymCentreInterfaceDAO {
     ...
     */
    List<FlipfitGymCentre> getAllCentresByOwnerId(String gymOwnerId);
     ...
     */
    void addGymCentre(FlipfitGymCentre centre);
     ...
     */
    List<FlipfitGymCentre> getPendingGymCentreList();
     ...
     */
    List<FlipfitGymCentre> getGymCentreListByCity(String city);
}
