...
public class FlipFitGymScheduleDAO implements FlipFitGymScheduleInterfaceDAO {

    public void addSchedule( FlipfitGymSchedule schedule){
        try{
    ...
    public FlipfitGymSchedule getSchedule(String scheduleId){
        FlipfitGymSchedule schedule = null;
        try{
            Connection conn = DBConnection.connect();
            ...
            while(rs.next()){
                ...
                schedule = new FlipfitGymSchedule(date, slotId, availability);
    ...
    public List<FlipfitGymSchedule> getAllScheduleByDate(Date date) {
        ArrayList<FlipfitGymSchedule> response = new ArrayList<>();
        try{
            Connection conn = DBConnection.connect();
