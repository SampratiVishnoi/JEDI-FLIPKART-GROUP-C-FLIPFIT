...
//    GymOwnerDAO gymOwnerDAO = new GymOwnerDAO();
    ...
    public void register() {
        ...
        FlipfitGymOwner gymOwner = new FlipfitGymOwner(userName,userName,password,email,panNumber,cardNumber);
    ...
    public void gymOwnerClientMainPage(String gymOwnerId) {
        ...
        while(true){
            ...
            switch (choice){
                ...
                case 0:
                    List<FlipfitGymCentre> allGymCentres = gymCentreService.getAllCentresByOwmerId(gymOwnerId);
                ...
                case 4:
                    ...
                    List<addSlotDTO> newSlotList = new ArrayList<>();
                    while (isAdding) {
                    ...
                    slotService.addSlotListForGym(centreId, newSlotList);
                    break;
                case 5:
