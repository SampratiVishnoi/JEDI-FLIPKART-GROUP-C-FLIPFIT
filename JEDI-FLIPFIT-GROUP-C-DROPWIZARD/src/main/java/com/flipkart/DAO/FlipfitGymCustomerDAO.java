...
public class FlipfitGymCustomerDAO implements FlipfitGymCustomerInterfaceDAO {

    public FlipfitGymCustomer registerCustomer(FlipfitGymCustomer customer) throws RegistrationFailedException {
        try {
    ...
    public FlipfitGymCustomer getCustomerById(String userName) {
        ...
        System.out.println("Rahul-Customer returned"+customer);
        return customer;
    }
