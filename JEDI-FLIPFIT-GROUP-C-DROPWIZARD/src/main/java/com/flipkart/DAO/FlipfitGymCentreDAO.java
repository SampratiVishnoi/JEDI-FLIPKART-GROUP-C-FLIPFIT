...
public class FlipfitGymCentreDAO implements FlipfitGymCentreInterfaceDAO {
    ...
    public List<FlipfitGymCentre> getAllCentresByOwmerId(String gymOwnerId)  {
        ...
        List<FlipfitGymCentre> allGymCentres = new ArrayList<>();
        try {
    ...
    public FlipfitGymCentre getGymCentreByCentreId(String gymCentreId){
        FlipfitGymCentre gymCentre = new FlipfitGymCentre();
        try {
    ...
    public FlipfitGymCentre addGymCentre(FlipfitGymCentre centre) {
        // call to db api
        try {
            conn = DBConnection.connect();
    ...
    public List<FlipfitGymCentre> getPendingGymCentreList() {
        List<FlipfitGymCentre> pendingList = new ArrayList<>();
        try {
            conn = DBConnection.connect();
...
//        }
    ...
    public List<FlipfitGymCentre> getGymCentreListByCity(String city) {
        List<FlipfitGymCentre> allCentreByCity = new ArrayList<>();
        try {
            conn = DBConnection.connect();
