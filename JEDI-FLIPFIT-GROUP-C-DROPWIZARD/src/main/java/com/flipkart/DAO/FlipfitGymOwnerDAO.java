...
public class FlipfitGymOwnerDAO implements FlipfitGymOwnerInterfaceDAO {
     ...
     * complete list of all GymOwners registered with FLIPFIT.
            ...
            try {
                ...
                while (result.next()) {
                    if (username.equals(result.getString("Id")) && password.equals(result.getString("password"))) {
                        ...
                        gymOwner = new FlipfitGymOwner(result.getString("Id"),result.getString("name"),result.getString("email"),result.getString("password"),result.getString("panNumber"),result.getString("cardDetails"));
                        return gymOwner;
                    } else {
                        return gymOwner;
                    }
    ...
    /**
     * Registers a new gym owner with the FLIPFIT platform and adds
