...
public class FlipfitGymCustomerController {
    FlipfitCustomerServiceInterface customerService = new FlipfitGymCustomerService();
    ...
    public Response getCustomerProfile(@QueryParam("userName") String userName){
        FlipfitGymCustomer customerProfile = customerService.viewMyProfile(userName);
    ...
    public Response customerRegister(@QueryParam("userId") String userId,@QueryParam("userName") String userName,@QueryParam("email") String email,@QueryParam("password") String password,@QueryParam("customerPhone") String customerPhone,@QueryParam("cardDetails") String cardDetails){
        FlipfitGymCustomer customer=new FlipfitGymCustomer(userId,userName,email,password,customerPhone,cardDetails);
        FlipfitGymCustomer customerProfile = customerService.registerCustomer(customer);
    ...
    public Response getCentresByCity(@QueryParam("city") String city){
        try{
            List<FlipfitGymCentre> gymCentreList = customerService.getAllGymCenterDetailsByCity(city);
    ...
    public Response getSlotsByCity(@QueryParam("centreId") String centreId,@QueryParam("date") String dateStr){
        try {
            ...
            List<FlipfitGymSlot> slots =  customerService.getAvailableSlots(centreId,sqlDate);
